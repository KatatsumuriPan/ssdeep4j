...
public final class FuzzyHasher {
	...
	public static final class FuzzyState {
		...
		/**
		 * A private inner class to hold the large static {@code SUM_TABLE} for better
		 * code organization and readability.
		 * <p>
		 * This table is a pre-computed lookup table used by the {@code sumHash} method
		 * to accelerate the hashing process.
		 */
		private static final class SumTable {

			public static final byte[][] SUM_TABLE =
					{
							{ // 0x00
